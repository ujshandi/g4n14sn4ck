...
12/09/14 19:34:36 - Gania
>Message: Table 'gania.mst_relation_animal' doesn't exist
>Dump: delete from mst_relation_animal where relation_id = 52

12/10/04 17:20:06 - Gania
>Message: Unknown column 'person_id' in 'field list'
>Dump: insert into trs_money_trans_mst (trans_num, trans_date, trans_type,  total, notes, person_id,insert_log) values ('UM20121000001',cast('2012-10-04 'as date),1,20000,'',26,'adm;2012-10-04 18:19:42 ')

12/10/07 12:35:34 - Gania
>Message: Table 'gania.mst_relation_service' doesn't exist
>Dump:  truncate table mst_relation_service

12/10/07 12:36:16 - Gania
>Message: Table 'gania.mst_relation_service' doesn't exist
>Dump:  update mst_relation_service set jumlah = 0, total =0

12/10/07 14:14:35 - Gania
>Message: Cannot add or update a child row: a foreign key constraint fails (`gania`.`inv_cashier_balance`, CONSTRAINT `FK_inv_cashier_balance` FOREIGN KEY (`cashier_id`) REFERENCES `mst_master` (`mst_id`) ON D
>Dump: insert into inv_cashier_balance (cashier_id, balance_date, user_id, shift_id, jenis_bayar, sales_value, disc_value, embalase, retur_value) values (0, curdate(), 'adm',0,0,3000, 0, 0, 0)

12/10/07 14:40:05 - Gania
>Message: Unknown column 't.retur_id' in 'field list'
>Dump: select distinct t.retur_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.relation_id) as Supplier, case when status_id = 0 then 'Un Posted' else 'Posted' end as Status,t.notes as 'Keterangan',t.Subtotal, t.Discount, t.tax as Pajak, t.Materai, t.Biaya, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-07 'as date)

12/10/07 14:40:50 - Gania
>Message: Unknown column 't.relation_id' in 'where clause'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.relation_id) as Supplier, case when status_id = 0 then 'Un Posted' else 'Posted' end as Status,t.notes as 'Keterangan',t.Subtotal, t.Discount, t.tax as Pajak, t.Materai, t.Biaya, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-07 'as date)

12/10/07 16:40:10 - Gania
>Message: Unknown column 't.relation_id' in 'where clause'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.relation_id) as Supplier, case when status_id = 0 then 'Un Posted' else 'Posted' end as Status,t.notes as 'Keterangan',t.Subtotal, t.Discount, t.tax as Pajak, t.Materai, t.Biaya, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-07 'as date)

12/10/07 16:42:54 - Gania
>Message: Unknown column 'status_id' in 'field list'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.pasien_id) as Supplier, case when status_id = 0 then 'Un Posted' else 'Posted' end as Status,t.notes as 'Keterangan',t.Subtotal, t.Discount, t.tax as Pajak, t.Materai, t.Biaya, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-07 'as date)

12/10/07 16:43:18 - Gania
>Message: Unknown column 'status_id' in 'field list'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.pasien_id) as Supplier, case when status_id = 0 then 'Un Posted' else 'Posted' end as Status,t.notes as 'Keterangan',t.Subtotal, t.Discount, t.tax as Pajak, t.Materai, t.Biaya, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-07 'as date)

12/10/07 16:46:51 - Gania
>Message: Unknown column 't.Discount' in 'field list'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.pasien_id) as Supplier, t.Subtotal, t.Discount, t.tax as Pajak, t.Materai, t.Biaya, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-07 'as date)

12/10/09 16:20:03 - Gania
>Message: Table 'gania.mst_rak_item' doesn't exist
>Dump: delete from mst_rak_item where item_id = 2

12/10/11 11:57:34 - Gania
>Message: Table 'gania.mst_pasien' doesn't exist
>Dump: select distinct O.sales_id, O.trans_num as 'No Trx', O.trans_date as 'Tgl Struk', (select nama from mst_pasien r where r.pasien_id= O.pasien_id) as Pasien, (O.Subtotal + O.disc_detail) as Subtotal, ((O.Subtotal + O.disc_detail) * (disc_mst/100) + disc_val_mst) as Discount, O.tax as Pajak, O.Total, O.sisa from trs_sales_mst O  where  O.trans_date >= cast('2012-10-01 'as date) and O.trans_date <=cast('2012-10-31 'as date) and O.relation_id = 3 and O.sisa > 0  order by O.trans_date, O.trans_num

12/10/11 12:37:01 - Gania
>Message: Table 'gania.mst_pasien' doesn't exist
>Dump: select distinct O.sales_id, O.trans_num as 'No Trx', O.trans_date as 'Tgl Struk', (select nama from mst_pasien r where r.pasien_id= O.pasien_id) as Pasien, (O.Subtotal + O.disc_detail) as Subtotal, ((O.Subtotal + O.disc_detail) * (disc_mst/100) + disc_val_mst) as Discount, O.tax as Pajak, O.Total, O.sisa from trs_sales_mst O  where  O.trans_date >= cast('2012-10-01 'as date) and O.trans_date <=cast('2012-10-31 'as date) and O.relation_id = 2 and O.sisa > 0  order by O.trans_date, O.trans_num

12/10/11 12:39:28 - Gania
>Message: Unknown column 'nama' in 'field list'
>Dump: select distinct O.sales_id, O.trans_num as 'No Trx', O.trans_date as 'Tgl Struk', (select nama from mst_relation r where r.relation_id= O.relation_id) as Customer, (O.Subtotal + O.disc_detail) as Subtotal, ((O.Subtotal + O.disc_detail) * (disc_mst/100) + disc_val_mst) as Discount, O.tax as Pajak, O.Total, O.sisa from trs_sales_mst O  where  O.trans_date >= cast('2012-10-01 'as date) and O.trans_date <=cast('2012-10-31 'as date) and O.relation_id = 2 and O.sisa > 0  order by O.trans_date, O.trans_num

12/10/11 12:40:05 - Gania
>Message: Unknown column 'O.relation_id' in 'where clause'
>Dump: select distinct O.sales_id, O.trans_num as 'No Trx', O.trans_date as 'Tgl Struk', (select relation_name from mst_relation r where r.relation_id= O.relation_id) as Customer, (O.Subtotal + O.disc_detail) as Subtotal, ((O.Subtotal + O.disc_detail) * (disc_mst/100) + disc_val_mst) as Discount, O.tax as Pajak, O.Total, O.sisa from trs_sales_mst O  where  O.trans_date >= cast('2012-10-01 'as date) and O.trans_date <=cast('2012-10-31 'as date) and O.sisa > 0  order by O.trans_date, O.trans_num

12/10/11 12:40:41 - Gania
>Message: Unknown column 'O.relation_id' in 'where clause'
>Dump: select distinct O.sales_id, O.trans_num as 'No Trx', O.trans_date as 'Tgl Struk', (select relation_name from mst_relation r where r.relation_id= O.relation_id) as Customer, (O.Subtotal + O.disc_detail) as Subtotal, ((O.Subtotal + O.disc_detail) * (disc_mst/100) + disc_val_mst) as Discount, O.tax as Pajak, O.Total, O.sisa from trs_sales_mst O  where  O.trans_date >= cast('2012-10-01 'as date) and O.trans_date <=cast('2012-10-31 'as date) and O.sisa > 0  order by O.trans_date, O.trans_num

12/10/14 11:03:03 - Gania
>Message: Unknown column 'r.pasien_id' in 'field list'
>Dump: select r.pasien_id, r.nama as 'Nama Pasien', 0 as 'Saldo Awal', (select ifnull(sum(t.total),0) from trs_sales_mst t  where t.pasien_id = r.pasien_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total > 0) as Pejualan, (select abs(ifnull(sum(t.total),0)) from trs_sales_mst t  where t.pasien_id = r.pasien_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total < 0) as Retur, (select ifnull(sum(t.subtotal + t.discount),0) from trs_payment_mst t  where t.pasien_id = r.pasien_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.tipe = 10) as Pembayaran, (select ifnull(sum(t.amount),0) from trs_debt_adjustment t  where t.pasien_id = r.pasien_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date)) as Penyesuaian, 0 as 'Saldo Akhir' from mst_relation r where r.relation_type = 1 order by relation_name

12/10/14 11:04:52 - Gania
>Message: Unknown column 'r.pasien_id' in 'field list'
>Dump: select r.pasien_id, r.nama as 'Nama Pasien', 0 as 'Saldo Awal', (select ifnull(sum(t.total),0) from trs_sales_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total > 0) as Pejualan, (select abs(ifnull(sum(t.total),0)) from trs_sales_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total < 0) as Retur, (select ifnull(sum(t.subtotal + t.discount),0) from trs_payment_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.tipe = 10) as Pembayaran, (select ifnull(sum(t.amount),0) from trs_debt_adjustment t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date)) as Penyesuaian, 0 as 'Saldo Akhir' from mst_relation r where r.relation_type = 1 order by relation_name

12/10/14 11:05:34 - Gania
>Message: Unknown column 'r.nama' in 'field list'
>Dump: select r.relation_id, r.nama as 'Nama Pasien', 0 as 'Saldo Awal', (select ifnull(sum(t.total),0) from trs_sales_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total > 0) as Pejualan, (select abs(ifnull(sum(t.total),0)) from trs_sales_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total < 0) as Retur, (select ifnull(sum(t.subtotal + t.discount),0) from trs_payment_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.tipe = 10) as Pembayaran, (select ifnull(sum(t.amount),0) from trs_debt_adjustment t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date)) as Penyesuaian, 0 as 'Saldo Akhir' from mst_relation r where r.relation_type = 1 order by relation_name

12/10/14 11:06:04 - Gania
>Message: Unknown column 't.pasien_id' in 'where clause'
>Dump: select r.relation_id, r.relation_name as 'Nama Customer', 0 as 'Saldo Awal', (select ifnull(sum(t.total),0) from trs_sales_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total > 0) as Pejualan, (select abs(ifnull(sum(t.total),0)) from trs_sales_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.total < 0) as Retur, (select ifnull(sum(t.subtotal + t.discount),0) from trs_payment_mst t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date) and t.tipe = 10) as Pembayaran, (select ifnull(sum(t.amount),0) from trs_debt_adjustment t  where t.pasien_id = r.relation_id and t.trans_date >= cast('2012-10-14 'as date) and t.trans_date <=cast('2012-10-14 'as date)) as Penyesuaian, 0 as 'Saldo Akhir' from mst_relation r where r.relation_type = 1 order by relation_name

12/10/14 11:08:18 - Gania
>Message: Unknown column 't.pasien_id' in 'where clause'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.pasien_id) as Customer, t.Subtotal, t.Disc_mst, t.tax as Pajak, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-14 'as date)

12/10/14 11:21:48 - Gania
>Message: Unknown column 'O.pasien_id' in 'where clause'
>Dump: select distinct O.sales_id, O.trans_num as 'No Trx', O.trans_date as 'Tgl Struk', (select relation_name from mst_relation r where r.relation_id= O.pasien_id) as Customer, (O.Subtotal + O.disc_detail) as Subtotal, ((O.Subtotal + O.disc_detail) * (disc_mst/100) + disc_val_mst) as Discount, O.tax as Pajak, O.Total, O.sisa from trs_sales_mst O  where  O.trans_date >= cast('2012-10-01 'as date) and O.trans_date <=cast('2012-10-31 'as date) and O.sisa > 0  order by O.trans_date, O.trans_num

12/10/15 18:01:30 - Gania
>Message: Table 'gania.trs_receipt' doesn't exist
>Dump: select distinct trans_date from trs_receipt where trans_date >= cast('2012-10-15 'as date) and trans_date <=cast('2012-10-15 'as date) order by trans_date

12/10/15 18:02:22 - Gania
>Message: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'from (  select sum(t.total) as net,  count(*) as spl , (select s
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur), from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where t.trans_type =6 and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =0 and (i.kategori is null or i.kategori =0)) as barang,  union all     select -1* sum(t.total + ifnull(t.dp,0)) as net, count(*)  as spl ,sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where t.trans_type =7 and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =0 ) as t1

12/10/15 18:36:53 - Gania
>Message: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur) from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where  and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =0 and (i.kategori is null or i.kategori =0)) as barang  from trs_receipt_mst  and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =0 union all     select -1* sum(t.total ) as net, count(*)  as spl ,0 as barang ,(select sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where  and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =0 ) as retur  from trs_retur_mst  and t.trans_date = cast('2012-10-15 'as date) and t.cara_bayar =0)  as t1

12/10/17 11:38:14 - Gania
>Message: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '.trans_date = cast('2012-10-07 'as date) and t.cara_bayar =0 uni
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur) from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where   t.trans_date = cast('2012-10-07 'as date) and t.cara_bayar =0 and (i.kategori is null or i.kategori =0)) as barang  from trs_receipt_mst   t.trans_date = cast('2012-10-07 'as date) and t.cara_bayar =0 union all     select -1* sum(t.total ) as net, count(*)  as spl ,0 as barang ,(select sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where   t.trans_date = cast('2012-10-07 'as date) and t.cara_bayar =0 ) as retur  from trs_retur_mst   t.trans_date = cast('2012-10-07 'as date) and t.cara_bayar =0)  as t1

12/10/17 11:51:54 - Gania
>Message: Every derived table must have its own alias
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur) from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where   t.trans_date = cast('2012-10-07 'as date) and (i.kategori is null or i.kategori =0)) as barang, 0 as retur  from trs_receipt_mst where   t.trans_date = cast('2012-10-07 'as date) )) as t2  union all     select -1* sum(t.total ) as net, count(*)  as spl ,0 as barang ,(select sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where   t.trans_date = cast('2012-10-07 'as date) ) as retur  from trs_retur_mst where   t.trans_date = cast('2012-10-07 'as date))  as t1

12/10/17 11:54:26 - Gania
>Message: Every derived table must have its own alias
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur) from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where   t.trans_date = cast('2012-10-07 'as date) and (i.kategori is null or i.kategori =0)) as barang, 0 as retur  from trs_receipt_mst where   t.trans_date = cast('2012-10-07 'as date) )) as t2  union all     select -1* sum(t.total ) as net, count(*)  as spl ,0 as barang ,(select sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where   t.trans_date = cast('2012-10-07 'as date) ) as retur  from trs_retur_mst where   t.trans_date = cast('2012-10-07 'as date))  as t1

12/10/17 11:54:44 - Gania
>Message: Unknown column 't.total' in 'field list'
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur) from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where   t.trans_date = cast('2012-10-07 'as date) and (i.kategori is null or i.kategori =0)) as barang, 0 as retur  from trs_receipt_mst t where   t.trans_date = cast('2012-10-07 'as date) union all     select -1* sum(t.total ) as net, count(*)  as spl ,0 as barang ,(select sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where   t.trans_date = cast('2012-10-07 'as date) ) as retur  from trs_retur_mst where   t.trans_date = cast('2012-10-07 'as date))  as t1

12/10/17 11:55:13 - Gania
>Message: Unknown column 't.total' in 'field list'
>Dump:  select sum(net),sum(spl),sum(barang),sum(retur) from (  select sum(t.total) as net,  count(*) as spl , (select sum(d.amount) from trs_receipt_mst t  inner join trs_receipt_detail d on d.receipt_id = t.receipt_id  inner join mst_item i on i.item_id = d.item_id  where   t.trans_date = cast('2012-10-07 'as date) and (i.kategori is null or i.kategori =0)) as barang, 0 as retur  from trs_receipt_mst t where   t.trans_date = cast('2012-10-07 'as date) union all     select -1* sum(t.total ) as net, count(*)  as spl ,0 as barang ,(select sum(d.amount) barang from trs_retur_mst t inner join trs_retur_detail d on d.retur_id = t.retur_id left join mst_item i on i.item_id = d.item_id where   t.trans_date = cast('2012-10-07 'as date) ) as retur  from trs_retur_mst where   t.trans_date = cast('2012-10-07 'as date))  as t1

12/10/17 13:36:14 - Gania
>Message: Unknown column 'd.disc' in 'field list'
>Dump: select concat(t.trans_num) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.disc_val, d.amount, t.trans_date, t.subtotal, t.disc_mst, t.disc_val_mst,(t.total+ifnull(t.dp,0)), d.receipt_detail_id as seq,  t.user_id,t.trans_type from trs_receipt_detail d, trs_receipt_mst t, mst_master u, mst_item i where d.receipt_id = t.receipt_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) UNION all select concat(t.trans_num,case when t.trans_type=7 then '(RETUR)' else '' end ) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.disc_val, d.amount, t.trans_date, t.subtotal, t.disc_mst, t.disc_val_mst,  (t.total+ifnull(t.dp,0)), d.retur_detail_id as seq,  t.user_id,t.trans_type from trs_retur_detail d, trs_retur_mst t, mst_master u, mst_item i where d.retur_id = t.retur_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) order by trans_date, trans_num, seq

12/10/17 13:37:40 - Gania
>Message: Unknown column 'd.disc' in 'field list'
>Dump: select concat(t.trans_num) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.disc_val, d.amount, t.trans_date, t.subtotal, t.disc_mst, t.disc_val_mst,(t.total+ifnull(t.dp,0)), d.receipt_detail_id as seq,  t.user_id,t.trans_type from trs_receipt_detail d, trs_receipt_mst t, mst_master u, mst_item i where d.receipt_id = t.receipt_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) UNION all select concat(t.trans_num,case when t.trans_type=7 then '(RETUR)' else '' end ) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.disc_val, d.amount, t.trans_date, t.subtotal, t.disc_mst, t.disc_val_mst,  (t.total+ifnull(t.dp,0)), d.retur_detail_id as seq,  t.user_id,t.trans_type from trs_retur_detail d, trs_retur_mst t, mst_master u, mst_item i where d.retur_id = t.retur_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) order by trans_date, trans_num, seq

12/10/17 13:37:57 - Gania
>Message: Unknown column 'd.disc_val' in 'field list'
>Dump: select concat(t.trans_num) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc1 as disc, d.disc_val, d.amount, t.trans_date, t.subtotal, t.disc_mst, t.disc_val_mst,(t.total+ifnull(t.dp,0)), d.receipt_detail_id as seq,  t.user_id,t.trans_type from trs_receipt_detail d, trs_receipt_mst t, mst_master u, mst_item i where d.receipt_id = t.receipt_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) UNION all select concat(t.trans_num,case when t.trans_type=7 then '(RETUR)' else '' end ) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.disc_val, d.amount, t.trans_date, t.subtotal, t.disc_mst, t.disc_val_mst,  (t.total+ifnull(t.dp,0)), d.retur_detail_id as seq,  t.user_id,t.trans_type from trs_retur_detail d, trs_retur_mst t, mst_master u, mst_item i where d.retur_id = t.retur_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) order by trans_date, trans_num, seq

12/10/17 13:41:40 - Gania
>Message: Unknown column 't.trans_type' in 'field list'
>Dump: select concat(t.trans_num) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc1 as disc, d.amount, t.trans_date, t.subtotal, t.disc_mst, (t.total), d.receipt_detail_id as seq,  t.user_id,t.tipe from trs_receipt_detail d, trs_receipt_mst t, mst_master u, mst_item i where d.receipt_id = t.receipt_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) UNION all select concat(t.trans_num,case when t.trans_type=7 then '(RETUR)' else '' end ) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.amount, t.trans_date, t.subtotal, t.disc_mst,  (t.total), d.retur_detail_id as seq,  t.user_id,t.tipe from trs_retur_detail d, trs_retur_mst t, mst_master u, mst_item i where d.retur_id = t.retur_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) order by trans_date, trans_num, seq

12/10/17 13:42:12 - Gania
>Message: Unknown column 't.disc_mst' in 'field list'
>Dump: select concat(t.trans_num) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc1 as disc, d.amount, t.trans_date, t.subtotal, t.disc_mst, (t.total), d.receipt_detail_id as seq,  t.user_id,t.tipe from trs_receipt_detail d, trs_receipt_mst t, mst_master u, mst_item i where d.receipt_id = t.receipt_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) UNION all select concat(t.trans_num,case when t.tipe=7 then '(RETUR)' else '' end ) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.amount, t.trans_date, t.subtotal, t.disc_mst,  (t.total), d.retur_detail_id as seq,  t.user_id,t.tipe from trs_retur_detail d, trs_retur_mst t, mst_master u, mst_item i where d.retur_id = t.retur_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-17 'as date) order by trans_date, trans_num, seq

12/10/18 13:03:47 - Gania
>Message: Unknown column 't.status_id' in 'where clause'
>Dump: select r.relation_id, r.relation_name as 'Nama Supplier', 0 as 'Saldo Awal', (select ifnull(sum(t.total),0) from trs_receipt_mst t  where t.relation_id = r.relation_id and t.status_id = 1  and t.trans_date >= cast('2012-10-18 'as date) and t.trans_date <=cast('2012-10-18 'as date)) as Pembelian, (select ifnull(sum(t.total),0) from trs_retur_mst t  where t.relation_id = r.relation_id and t.status_id = 1  and t.trans_date >= cast('2012-10-18 'as date) and t.trans_date <=cast('2012-10-18 'as date)) as Retur, (select ifnull(sum(t.subtotal + t.discount),0) from trs_payment_mst t  where t.relation_id = r.relation_id and t.status_id = 1  and t.trans_date >= cast('2012-10-18 'as date) and t.trans_date <=cast('2012-10-18 'as date) and t.tipe = 9) as Pembayaran, (select ifnull(sum(t.amount),0) from trs_debt_adjustment t  where t.relation_id = r.relation_id and t.status_id = 1  and t.trans_date >= cast('2012-10-18 'as date) and t.trans_date <=cast('2012-10-18 'as date)) as Penyesuaian, 0 as 'Saldo Akhir' from mst_relation r where r.relation_type = 2 order by relation_name

12/10/19 09:16:51 - Gania
>Message: Unknown column 't.cara_bayar' in 'where clause'
>Dump: select concat(t.trans_num) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc1 as disc, d.amount, t.trans_date, t.subtotal, t.disc_mst, (t.total), d.receipt_detail_id as seq,  t.user_id,t.tipe from trs_receipt_detail d, trs_receipt_mst t, mst_master u, mst_item i where d.receipt_id = t.receipt_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-19 'as date) and t.cara_bayar =0 UNION all select concat(t.trans_num,case when t.tipe=7 then '(RETUR)' else '' end ) as trans_num, i.barcode, i.item_name, d.price, (d.quantity / d.conversion) as quantity, u.mst_code, d.disc, d.amount, t.trans_date, t.subtotal, 0 as disc_mst,  (t.total), d.retur_detail_id as seq,  t.user_id,t.tipe from trs_retur_detail d, trs_retur_mst t, mst_master u, mst_item i where d.retur_id = t.retur_id and d.item_id is not null and i.kemasan_id = u.mst_id and d.item_id = i.item_id  and t.trans_date >= cast('2012-10-01 'as date) and t.trans_date <=cast('2012-10-19 'as date) and t.cara_bayar =0 order by trans_date, trans_num, seq

12/12/12 20:51:11 - Gania
>Message: Unknown column 'relation_id' in 'field list'
>Dump: insert into trs_holded_mst (trans_num, trans_date, cashier_id, relation_id, dokter_id, no_resep, embalase, subtotal, disc_mst, disc_val_mst, tax, total, profit, points, relation_type, animal_seq,animal_id,dp,user_id) values ('customerA001',cast('2012-12-12 'as date),5,43,NULL,'',0,8000,0,0,0,8000,300,0,1,'','',0,'adm')

12/12/12 20:59:38 - Gania
>Message: Table 'gania.mst_relation_animal' doesn't exist
>Dump: select hold_id, trans_num as 'No.Trans',trans_date as 'Tgl.Trans', relation_name as Customer, '' as 'Nawa Hewan', total as Jumlah ,r.relation_id,t.animal_seq,'' from trs_holded_mst t left join mst_relation r on t.pasien_id = r.relation_id  left join mst_relation_animal a on r.relation_id = a.relation_id and t.animal_seq = a.seq  order by trans_num

12/12/12 21:04:32 - Gania
>Message: Unknown column 'relation_id' in 'field list'
>Dump: select hold_id, trans_num, trans_date, user_id, cashier_id, subtotal, disc_mst, disc_val_mst, tax, total, profit, relation_id, relation_type, points, dokter_id, no_resep ,animal_seq,animal_id,dp from trs_holded_mst where hold_id = 1

12/12/12 21:05:51 - Gania
>Message: Unknown column 'relation_id' in 'field list'
>Dump: update trs_holded_mst set trans_date = cast('2012-12-12 'as date), cashier_id = 5, subtotal = 18300, disc_mst = 0, disc_val_mst = 0, tax = 0, total = 18300, points = 0, relation_type = 1, relation_id = 41, dokter_id = NULL, embalase = 0, no_resep = '', animal_seq = '', animal_id = '', dp = 0, user_id = 'adm' where hold_id = 1

12/12/12 21:08:44 - Gania
>Message: Unknown column 't.amount' in 'field list'
>Dump: select t.trans_date, t.relation_id, t.gudang_id, t.amount, ifnull(d.item_id, 0), (d.quantity + d.qty_bonus) as qty, ifnull(d.paket_id, 0), d.points, d.sales_id from trs_sales_detail d, trs_sales_mst t where d.sales_id = t.sales_id and d.sales_detail_id = 38

12/12/12 21:08:54 - Gania
>Message: Unknown column 't.amount' in 'field list'
>Dump: select t.trans_date, t.relation_id, t.gudang_id, t.amount, ifnull(d.item_id, 0), (d.quantity + d.qty_bonus) as qty, ifnull(d.paket_id, 0), d.points, d.sales_id from trs_sales_detail d, trs_sales_mst t where d.sales_id = t.sales_id and d.sales_detail_id = 38

12/12/18 12:07:51 - Gania
>Message: Unknown column 'person_id' in 'field list'
>Dump: insert into trs_money_trans_mst (trans_num, trans_date, trans_type,  total, notes, person_id,insert_log) values ('UK20121200001',cast('2012-12-18 'as date),16,3000,'',0,'adm;2012-12-18 12:07:27 ')

12/12/22 15:51:41 - Gania
>Message: Unknown column 't.trans_type' in 'where clause'
>Dump: select ifnull(sum(subtotal+biaya+materai+tax),0) from trs_receipt_mst t  where  t.trans_type =6 and t.trans_date >= cast('2012-12-01 'as date) and t.trans_date <=cast('2012-12-22 'as date)

12/12/24 19:16:32 - Gania
>Message: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '44300 where sales_id = 1' at line 1
>Dump:  update trs_sales_mst set subtotal = 44300, profit = 425, disc_mst= 0, disc_val_mst= 0, disc_detail= 0, tax= 0, total= 44300, embalase= 0, real_amount = 44300, sisa = 0, cash  44300 where sales_id = 1

12/12/26 05:03:36 - Gania
>Message: Unknown column 't.tipe' in 'where clause'
>Dump: select distinct t.sales_id, t.trans_num as 'No Trx', t.trans_date as 'Tgl Jual', (select relation_name from mst_relation r where r.relation_id= t.relation_id) as Customer, case when status_id = 0 then 'Un Posted' else 'Posted' end as Status, t.Subtotal, t.Disc_mst, t.tax as Pajak, t.Total from trs_sales_mst t  where  t.trans_date >= cast('2012-12-01 'as date) and t.trans_date <=cast('2012-12-26 'as date) and t.tipe = 14

13/01/04 00:58:58 - Gania
>Message: Unknown column 'Stok' in 'field list'
>Dump: select distinct i.item_id, i.item_code as 'Kode', i.item_name as Nama,merk as Merk,  get_stock_akhir(i.item_id, curdate()) as Stok ,i.buying_price as 'H.Beli Terakhir', (Stok * i.buying_price) as 'Nilai Stok' from mst_item i, point_maping p where i.disabled_date is null and i.specification = p.code_id  and p.root_id =1 order by item_name 

13/02/28 21:53:31 - Gania
>Message: Unknown column 't.relation_id' in 'where clause'
>Dump: select distinct trans_date from trs_receipt_mst where trans_date >= cast('2013-02-01 'as date) and trans_date <=cast('2013-02-28 'as date) and t.relation_id =23 union  select distinct trans_date from trs_retur_mst where trans_date >= cast('2013-02-01 'as date) and trans_date <=cast('2013-02-28 'as date) and t.relation_id =23 order by trans_date
