...
begin
  ...
  case Purpose of
    ...
    ITEM_TYPE_MUTASI_KELUAR : BEGIN
        ...
        Shipment.ShipmentMst.GudangAsal:= GlobalSystemConfig.localSetting.LocalGudang;;//cmbAsal.Tag;
        Shipment.ShipmentMst.GudangTujuan:= GlobalSystemConfig.localSetting.LocalGudang;//cmbAsal.Tag;
    end;
  end;
...
begin
  ...
  if (Purpose IN [ITEM_TYPE_MUTASI_MASUK,ITEM_TYPE_MUTASI_KELUAR,ITEM_TYPE_OPNAME]) then begin
    for i:= 1 to grid.RowCount-1 do begin
