...
uses UConstTool, MainMenu, Subroutines,
  ...
  UTransaction, UConst, UQueryPackage;
...
begin
  ...
  else if Self.Tag = 221 then begin Purpose:= RELASI_TYPE_NASABAH ; suiPanel2.Caption := 'Daftar Nasabah'; end
...
begin
  try
    ...
    if Purpose = RELASI_TYPE_NASABAH then grid.ColWidths[colSaldo  ]:= 80;
