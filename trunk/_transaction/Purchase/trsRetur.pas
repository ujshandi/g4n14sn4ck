...
begin
  ...
  Trx.Notes      := txtNotes.Text+';'+txtNoFaktur.Text;
...
begin
  ...
  for i:= 1 to grid.RowCount-1 do begin
   ...
   if CekInput(Result,TTrsReceipt.isExistNoFaktur(txtNoFaktur.Text),'Nomor Faktur yang akan diretur belum ada',txtNoFaktur) then
...
begin
  ...
  txtNotes.Text:= EkstrakString(Trx.Notes,';',1);
  txtNoFaktur.Text := EkstrakString(Trx.Notes,';',2);
