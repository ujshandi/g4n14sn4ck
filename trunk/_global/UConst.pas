...
const
  ...
  DATE_VERSION = 'v.01.03.13';

  MODUL_PATH = '\Software\Invisi\gania';
  ...
  TRANS_TYPE_DANA_INPUT  = 11;  //nabung
  TRANS_TYPE_DANA_OUTPUT = 12;//ambil tabungan

  TRANS_TYPE_SALES = 13;
  TRANS_TYPE_SALES_RETUR = 14;
