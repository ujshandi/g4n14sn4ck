...
begin
  ...
  PageControl1.Pages[2].Enabled:=  GlobalSystemUser.AccessLevel > LEVEL_OWNER;
  TabSheet4.Visible:=  GlobalSystemUser.AccessLevel > LEVEL_OWNER;
  TabSheet4.Enabled:=  GlobalSystemUser.AccessLevel > LEVEL_OWNER;
  txtFooter1.Enabled:= MANAGEMENT_VERSION;
  txtFooter2.Enabled:= MANAGEMENT_VERSION;
  btnEmpty.Visible := GlobalSystemUser.AccessLevel >= LEVEL_OWNER;
