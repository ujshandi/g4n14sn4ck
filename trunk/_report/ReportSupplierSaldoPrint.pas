...
procedure TqrpReportSupplierSaldo.Executes(AGrid: TAdvStringGrid;aPurpose:integer);
begin
  Grid:= AGrid;
  ...
  qrlColNama.Caption := IfThen(aPurpose=TRANS_TYPE_PEMBAYARAN,'Nama Supplier','Nama Customer');
  qrlTitle.Caption := IfThen(aPurpose=TRANS_TYPE_PEMBAYARAN,'Saldo Supplier','Saldo Customer');
